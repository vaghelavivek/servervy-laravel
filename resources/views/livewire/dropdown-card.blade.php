<li class="relative">
    ...
    <div class="text-black flex xl:justify-center justify-between w-full items-center cursor-pointer" wire:click="dropdownToggale" wire:click.outside="dropdownClose">
        @if ($list)
